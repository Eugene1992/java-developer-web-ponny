...
<main>
    <div class="container">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link" id="category-tab" data-toggle="tab" href="#categories" role="tab"
                    ...
                    <div class="col-lg-8">
                        <div class="input-group margin-top-bottom-15">
                            <a href="/admin/categories/new">
                                <button class="btn btn-success" type="button">New Category</button>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                ...
                <table class="table table-bordered">
                    ...
                    <c:forEach var = "category" items="${allcategories}">
                        <tr>
                            ...
                            <td class="table-btn-col">
                                <a href="/admin?action=updateCategory&id=${category.id}">
                                    <button type="button" class="btn btn-warning btn-sm">
                                        <i class="fa fa-edit fa-xs fa-lg"></i>
                                    </button>
                                </a>
                            ...
                            <td class="table-btn-col">
                                <a href="/admin?action=deleteCategory&id=${category.id}">
                                    <button type="button" class="btn btn-danger btn-sm">
                                        <i class="fa fa-remove fa-xs fa-lg"></i>
                                    </button>
                                </a>
